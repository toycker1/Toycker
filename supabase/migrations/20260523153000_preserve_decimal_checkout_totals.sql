-- Fix: preserve 2-decimal checkout totals for club and full online payment discounts.
-- Keeps the current gift-wrap source-of-truth behavior from 20260509174500.
